      ...
      child: BlocConsumer<TheBestCubit, TheBestState>(
        ...
        builder: (context, state) {
          ...
          return LoadingAndError(
            isLoading: state is LoadingTheBestTeachersState,
            errorMessage: state is ErrorTheBestState ? state.error : null,
            isError: State is ErrorTheBestState,
            child: cubit.bestTeachersModel?.data != null &&
                    cubit.bestTeachersModel!.data!.isNotEmpty
                ? Container(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: RefreshIndicator(
                            onRefresh: () async => cubit.getBestTeachers(),
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) =>
                                ...
                                Padding(
                                  ...
                                  child: Row(children: [
                                    ...
                                    Expanded(
                                        child: GradientText(
                                            "${cubit.bestTeachersModel!.data![index].avgRate}%",
                                            style: TextStyle(
                                              fontSize: 13.0.sp,
                                              fontWeight: FontWeight.w500,
                                            ),
                              ...
                              itemCount: cubit.bestTeachersModel!.data!.length,
                            ),
                          ),
                        )
                      ],
